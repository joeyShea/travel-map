  ...
  return (
    <div className="flex h-full w-[420px] flex-col bg-card border-r border-border">
      ...
      <div className="relative h-56 flex-shrink-0">
        ...
        <button
          onClick={onClose}
          className="absolute right-3 top-3 flex h-8 w-8 items-center justify-center rounded-full bg-background/60 backdrop-blur-sm text-foreground transition-colors hover:bg-background/90"
