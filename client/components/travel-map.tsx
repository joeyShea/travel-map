...
export default function TravelMap() {
  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden bg-background">
      {/* Logo */}
      <div className="absolute left-4 top-4 z-30 flex items-center gap-2 rounded-full bg-card/80 backdrop-blur-sm px-4 py-2 border border-border"
        style={{ left: showSidebar ? 'calc(420px + 1rem)' : showFullScreen ? 'calc(480px + 1rem)' : '1rem', transition: 'left 0.4s cubic-bezier(0.4, 0, 0.2, 1)' }}
      >
