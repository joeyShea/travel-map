  ...
  return (
    <div className="flex h-full w-[480px] flex-col bg-card border-r border-border">
      ...
      <div className="relative h-64 flex-shrink-0">
        ...
        <button
          onClick={onBack}
          className="absolute left-4 top-4 flex items-center gap-2 rounded-full bg-background/60 backdrop-blur-sm px-3 py-1.5 text-sm font-medium text-foreground transition-colors hover:bg-background/90"
        >
